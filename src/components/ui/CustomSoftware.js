    ...
    return(
        <Grid container direction="column" >
            <Grid item container direction="row" justify={ matchesMD ? "center" : undefined } className={classes.rowContainer} style={{marginTop: matchesXS ? "1em" : "2em"}}>
                ...
                <Hidden mdDown>
                    <Grid item className={classes.arrowContainer}>
                        <IconButton component={Link} to="/mobileapps" style={{backgroundColor: 'transparent'}} onClick={() => props.setSelectedIndex(2)}>
                            <img src={forwardArrow} alt="Go to Mobile Apps page"/>
                        </IconButton>
                    </Grid>
                </Hidden>
            </Grid>
            ...
            <Grid item container direction={ matchesMD ? "column" : "row"} alignItems={matchesMD ? "center" : undefined} justify="space-around" className={classes.rowContainer}>
                <Grid item container style={{marginBottom: matchesMD ? "15em" : 0}} className={classes.itemContainer} direction={matchesSM ? "column" : "row"} md>
